...
public class ShapeGun implements IGuns {
	private int posXgun;
	private int posYgun;
	...
	public void PrintGun(Graphics g, Color colorGun,int posXgun,int posYgun) {
   	 	g.setColor(colorGun);
   	 	int [] gunsX= {posXgun+ 5,posXgun+ 15,posXgun+25,posXgun+30,posXgun+35,posXgun+38,posXgun+35,posXgun+18};
	    int [] gunsY= {posYgun-10,posYgun-30,posYgun-35,posYgun-32,posYgun-38,posYgun-35,posYgun-20,posYgun-10};
